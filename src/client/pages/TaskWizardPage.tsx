...
export function TaskWizardPage({ fromSavedId }: { fromSavedId?: string }) {
  ...
  const hasFilters = !!(media.length || minSize !== "" || maxSize !== "");
  const sourceReady =
    sourceChat &&
  ...
  return (
    <div className="content-container wizard-container">
      <PageHero
        title="New task"
        subtitle="Choose your bot and chats, then start copying."
      >
      ...
      <section className="card wizard-card">
        {step === 0 && (
          <div className="stack">
            ...
            {!!bots?.length && (
              <div className="field">
                <label className="form-label" htmlFor="select-bot">
                  Connected bot
                </label>
                <select
                  className="input"
        ...
        {step === 2 && (
          <div className="stack">
            ...
            {scope !== "backfill_only" && (
              <details className="advanced-section">
                <summary>
                  More options{hasFilters ? " · filters on" : ""}
                </summary>
                <div className="stack">
                  <div>
                    <h3 className="card-title">Filter new messages</h3>
                    <p className="helper">
                      Optional. By default, every available new message is
                      copied. These filters do not apply to existing history.
                    </p>
                  </div>
                  ...
                  <p className="helper">
                    Leave all unchecked to allow every type. Telegram treats a
                    video sent as a file as a Document.
                  </p>
                  <div className="form-grid">
                    <div className="field">
                  ...
                  <p className="helper">
                    Leave sizes empty for no size limit. Messages without a
                    reported file size are unaffected by size limits.
                  </p>
                  {hasFilters && (
                    <button
                      type="button"
              ...
              <div>
                ...
                <dd>
                  {scope === "backfill_only"
                    ? "Not applicable"
                    : hasFilters
                      ? `${media.length ? media.join(", ") : "All message types"}${minSize ? ` · min ${minSize} MB` : ""}${maxSize ? ` · max ${maxSize} MB` : ""}`
                      : "None"}
                </dd>
              </div>
            </dl>
