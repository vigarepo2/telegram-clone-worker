...
export function SavedTasksPage() {
  ...
  return (
    <div className="content-container">
      <PageHero
        title="Saved setups"
        subtitle="Reuse your bot and chat choices. Review them before starting a new task."
      ></PageHero>
              ...
              <div className="task-actions">
                ...
                <div className="option-help">
                  <button
                    ...
                    aria-label={`Remove saved setup from ${item.source_chat_title || item.source_chat_id} to ${item.dest_chat_title || item.dest_chat_id}`}
                    disabled={busy}
